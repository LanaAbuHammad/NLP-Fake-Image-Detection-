...
class Root(Tk):
    def __init__(self):
        ...
        self.configure(background='#690E3A')
        self.resizable(False, False)
        self.path = StringVar()
       
        #TITLE IN CENTER
        self.label1 = tk.Label(self, text="REAL/FAKE DETECTOR",bg='#C37D9F')
        self.label1.config(font=("Comic 18 bold"))
        
        self.label1.place(y=14,x=350)

        self.label3 = tk.Label(self, text="Caption in Arabic",bg='#C37D9F')
        self.label3.config(font=("Comic 12 bold"))
        ...
        self.selectlabel = tk.Label(self, text="Select Picture", bg='#C37D9F')
        self.selectlabel.config(font=("Comic 12 bold"))
    ...
    def browsebButton(self):
        ...
        self.button.grid(row = 1, column = 3, pady = 10, padx = 100)
    ...
    def msgBox(self):
        ...
        accuracy = labeler.trainingPhase("C:\\Users\\ThinkPad\\Desktop\\COURSE PROJECT\\DETECTOR\\Labeled.csv")
